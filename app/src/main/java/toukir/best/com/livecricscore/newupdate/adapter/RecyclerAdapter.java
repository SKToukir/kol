...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView team_one, team_two, txtWonTheToss, txtMatchStarted;
        public ImageView teamOneImage, teamTwoImage;

        public MyViewHolder(View view) {
            super(view);
            txtMatchStarted = (TextView) view.findViewById(R.id.txtMatchStarted);
            txtWonTheToss = (TextView) view.findViewById(R.id.txtWonTheToss);
    ...
    public RecyclerAdapter(List<Matches> moviesList, Context context) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        String isMatchStarted = matches.getMatch_started();

        if (isMatchStarted!=null){
//
//            if (isMatchStarted.equals("true")) {
//                holder.txtMatchStarted.setText("Match Started");
//                holder.txtWonTheToss.setText(matches.getToss_winner_team() + " won the toss!");
//            } else {
//                holder.txtMatchStarted.setVisibility(View.GONE);
//                holder.txtWonTheToss.setVisibility(View.GONE);
//            }

            holder.txtMatchStarted.setText(matches.getMatch_started());
            holder.txtWonTheToss.setText(matches.getToss_winner_team());
            ...
            } else if (teamOne.equalsIgnoreCase("Dhaka Dynamites")) {
                holder.teamOneImage.setImageResource(R.drawable.dhaka_dynamites);
            }else if (teamOne.equalsIgnoreCase("Rajshahi Kings")) {
                holder.teamOneImage.setImageResource(R.drawable.rajshahi_kings);
            }else if (teamOne.equalsIgnoreCase("Khulna Titans")) {
                holder.teamOneImage.setImageResource(R.drawable.khulna_titans);
            }else if (teamOne.equalsIgnoreCase("Rangpur Riders")) {
                holder.teamOneImage.setImageResource(R.drawable.rangpur_riders);
            }else if (teamOne.equalsIgnoreCase("Sylhet Sixers")) {
                holder.teamOneImage.setImageResource(R.drawable.sylhet_sixers);
            } else if (teamOne.equalsIgnoreCase("Comilla Victorians")) {
                holder.teamOneImage.setImageResource(R.drawable.comilla_victorians);
            }else if (teamOne.equalsIgnoreCase("Chittagong Vikings")) {
                holder.teamOneImage.setImageResource(R.drawable.chittagang_vikings);
            } else {
                holder.teamOneImage.setImageResource(R.drawable.dlogo);
            }
            ...
            }else if (teamTwo.equalsIgnoreCase("Dhaka Dynamites")) {
                holder.teamTwoImage.setImageResource(R.drawable.dhaka_dynamites);
            }else if (teamTwo.equalsIgnoreCase("Rajshahi Kings")) {
                holder.teamTwoImage.setImageResource(R.drawable.rajshahi_kings);
            }else if (teamTwo.equalsIgnoreCase("Khulna Titans")) {
                holder.teamTwoImage.setImageResource(R.drawable.khulna_titans);
            }else if (teamTwo.equalsIgnoreCase("Rangpur Riders")) {
                holder.teamTwoImage.setImageResource(R.drawable.rangpur_riders);
            }else if (teamTwo.equalsIgnoreCase("Sylhet Sixers")) {
                holder.teamTwoImage.setImageResource(R.drawable.sylhet_sixers);
            } else if (teamTwo.equalsIgnoreCase("Comilla Victorians")) {
                holder.teamTwoImage.setImageResource(R.drawable.comilla_victorians);
            }else if (teamTwo.equalsIgnoreCase("Chittagong Vikings")) {
                holder.teamTwoImage.setImageResource(R.drawable.chittagang_vikings);
            }else {
                holder.teamTwoImage.setImageResource(R.drawable.dlogo);
            }
