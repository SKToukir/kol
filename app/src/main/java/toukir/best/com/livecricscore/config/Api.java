...
public class Api {
    ...
    public static final String CRICKET_MATCH_STARTED = "matchStarted";
    public static final String CRICKET_TOSS_WINNER_TEAM = "toss_winner_team";
    public static final String OLD_MATCH_API = "http://cricapi.com/api/cricket?apikey=";
