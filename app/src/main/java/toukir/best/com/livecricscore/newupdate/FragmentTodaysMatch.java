...
public class FragmentTodaysMatch extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter = new RecyclerAdapter(matchesList,getContext());
...
//                startActivity(new Intent(getActivity(),ScoreBoard.class));
    ...
    private void showScoreDialog(String type, final String innings_requirement, String score, String team_one, String team_two) {
        ...
        txtDescription.setText(innings_requirement.replaceAll("&amp;","&"));
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        matches.setMatch_started(object.getString(Api.CRICKET_MATCH_STARTED));

                        if (matches.getMatch_started().equals("true")){
                            matches.setMatch_started("Match Started");
                            matches.setToss_winner_team(object.getString("toss_winner_team")+" won the toss!");
                        }else {
                            matches.setMatch_started("");
                            matches.setToss_winner_team("");
                        }
